...
const SystemItem = ({ title, desc }) => (
  <div className="group border-b border-gray-100 dark:border-white/5 pb-4 last:border-0">
    <h5 className="text-sm font-black text-dark dark:text-white uppercase mb-1 group-hover:text-primary transition-colors">
      {title}
    </h5>
    ...
    <section className="py-20 bg-white dark:bg-[#050a15]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          {/* Types */}
          <div>
            <h3 className="text-xl font-black text-dark dark:text-white uppercase mb-8 flex items-center gap-2">
