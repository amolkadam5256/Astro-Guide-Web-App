...
const IntroHero = () => {
  return (
    <section className="bg-gray-50 dark:bg-dark py-16 border-b border-gray-100 dark:border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-primary/10 text-primary rounded-full text-[10px] font-black uppercase tracking-widest mb-6">
              <Hash size={12} />
              <span>Ancient Wisdom</span>
            </div>
            <h1 className="text-3xl md:text-4xl font-black text-dark dark:text-white uppercase leading-tight mb-6">
              What is <span className="text-primary">Numerology?</span>
            </h1>
            <div className="space-y-4 text-gray-600 dark:text-gray-400 text-sm md:text-base leading-relaxed">
              ...
              <p className="font-bold text-dark dark:text-white italic bg-white dark:bg-white/5 p-4 border-l-4 border-[var(--color-secondary)]">
