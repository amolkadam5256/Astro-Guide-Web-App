...
const ConceptCard = ({ icon, title, desc, formula, example }) => (
  <div className="p-6 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl hover:bg-white dark:hover:bg-primary/5 transition-all group active:scale-[0.98]">
    <div className="w-10 h-10 bg-white dark:bg-dark text-[var(--color-secondary)] rounded-xl flex items-center justify-center mb-6 shadow-sm border border-gray-100 dark:border-white/10 group-hover:scale-110 transition-transform">
      {icon}
    </div>
    <h4 className="text-sm font-black uppercase tracking-widest text-dark dark:text-white mb-3">
      {title}
    </h4>
    ...
    <div className="pt-4 border-t border-gray-100 dark:border-white/10 space-y-2">
      <p className="text-[10px] uppercase font-black text-primary">Method:</p>
    ...
    <section className="py-20 bg-white dark:bg-[#050a15]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-black text-dark dark:text-white uppercase mb-4">
            Core Concepts
          </h2>
