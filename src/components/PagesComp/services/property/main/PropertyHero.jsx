    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden py-24 px-4 bg-white dark:bg-[#050a15]">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-8">
        ...
        >
          ...
          <span>Architectural Vastu-Numerology</span>
        </div>
        ...
        >
          Property <br />
          <span className="text-primary italic opacity-90">Analysis</span>
        </h1>
        ...
        <p
          ...
          data-aos-delay="100"
        >
          Ensure your physical environments support your physical health and
          financial growth. Specialized audits for residential and commercial
          spaces.
        </p>
