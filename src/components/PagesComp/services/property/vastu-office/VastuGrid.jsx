    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {cards.map((card, i) => (
        <div
          ...
          className="p-12 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-[2rem] group hover:bg-primary transition-all"
        >
          <h3 className="text-2xl font-black text-dark dark:text-white mb-4 group-hover:text-white uppercase">
            {card.title}
          </h3>
