...
const LuckyDatesHero = () => {
  return (
    <div className="text-center mb-16" data-aos="zoom-out">
      ...
      <h1 className="text-3xl md:text-5xl font-black text-dark dark:text-white uppercase mb-6 tracking-tighter leading-tight">
        Lucky <span className="text-primary">Vibrations</span>
      </h1>
