...
const CalcStep = ({ title, formula, example }) => (
  <div className="space-y-2 border-l-2 border-primary/20 pl-6 py-2 hover:border-primary transition-colors">
      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right">
            <h2 className="text-xl font-black text-dark dark:text-white uppercase mb-8 flex items-center gap-3">
