    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden py-24 px-4 bg-white dark:bg-[#050a15]">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-8">
        ...
        >
          ...
          <span>Self-Discovery Analysis</span>
        </div>

        <h1
          className="text-4xl md:text-6xl lg:text-7xl font-black text-dark dark:text-white mb-4 uppercase tracking-tighter leading-none"
          data-aos="fade-up"
        >
          Personal <br />
          <span className="text-primary italic opacity-90">Mastery</span>
        </h1>
        ...
        <p
          ...
          data-aos-delay="100"
        >
          Discover the hidden blueprint of your identity and destiny through
          your unique numbers. Align your life with your higher purpose.
        </p>
        ...
        >
          <Link
            to="/contact"
            className="w-full sm:w-auto px-10 py-5 bg-primary hover:bg-primary-dark-1 text-white font-black uppercase tracking-[0.3em] text-[9px] transition-all flex items-center justify-center gap-3 group shadow-xl rounded-sm"
          >
            Start My Journey
