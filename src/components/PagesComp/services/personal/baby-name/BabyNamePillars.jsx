...
const PillarItem = ({ title, desc }) => (
  <div className="p-6 bg-white dark:bg-white/5 border border-gray-100 dark:border-white/5 rounded-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
      <h4 className="text-xs sm:text-sm font-black text-dark dark:text-white uppercase mb-1">
        {title}
      </h4>
...
const BabyNamePillars = () => {
  return (
    <section className="py-20 bg-gray-50 dark:bg-dark border-y border-gray-100 dark:border-white/5">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-xl font-black text-center text-dark dark:text-white uppercase mb-12 tracking-widest">
