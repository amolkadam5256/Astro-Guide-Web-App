    ...
    <section className="py-24 bg-gray-50 dark:bg-dark">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-2xl font-black uppercase text-dark dark:text-white mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
          {numberTraits.map((item, i) => (
            <div
              key={i}
              className="group p-6 bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl text-center hover:border-primary transition-all"
            >
              <div className="text-2xl font-black text-primary mb-2 group-hover:scale-125 transition-transform">
                {item.num}
              </div>
