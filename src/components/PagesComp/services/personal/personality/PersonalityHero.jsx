...
const TraitMiniCard = ({ icon, title, desc }) => (
  <div className="p-4 bg-white dark:bg-black/20 border border-gray-100 dark:border-white/5 rounded-xl hover:bg-gray-50 dark:hover:bg-black/40 transition-colors group">
    <div className="flex items-center space-x-3 mb-2">
      ...
      <h5 className="text-[11px] font-black uppercase tracking-widest text-dark dark:text-white">
        {title}
      </h5>
    </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2" data-aos="zoom-in">
            <div className="relative aspect-square max-w-md mx-auto flex items-center justify-center">
              ...
              <div className="absolute inset-8 border border-dashed border-primary/30 rounded-full"></div>
              <div className="relative text-center p-8">
                <User size={48} className="text-primary mx-auto mb-4" />
                <h2 className="text-xl font-black uppercase text-dark dark:text-white">
                  The Mirror
                </h2>
          ...
          <div className="w-full lg:w-1/2" data-aos="fade-left">
            <h1 className="text-3xl md:text-5xl font-black text-dark dark:text-white uppercase mb-8 leading-tight">
              Personality <span className="text-primary">Traits</span>
            </h1>
