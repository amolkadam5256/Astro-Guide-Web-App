  ...
  return (
    <section className="py-20 bg-white dark:bg-[#050a15] border-t border-gray-100 dark:border-white/5">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <h2 className="text-xl sm:text-2xl font-black text-dark dark:text-white uppercase mb-6 italic">
        ...
        <button className="px-8 py-3 bg-primary text-white text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-[var(--color-secondary)] transition-colors shadow-lg shadow-blue-500/20">
