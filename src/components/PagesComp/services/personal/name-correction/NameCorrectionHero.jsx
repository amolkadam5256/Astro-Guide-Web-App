        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div data-aos="fade-right">
            ...
            <h1 className="text-3xl md:text-5xl font-black text-dark dark:text-white uppercase mb-8 leading-tight">
              Name <span className="text-primary">Correction</span>
            </h1>
            ...
            <button className="group px-8 py-4 bg-primary text-white text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:bg-[var(--color-secondary)] flex items-center space-x-3">
          ...
          <div
            className="relative p-10 bg-dark rounded-[40px] overflow-hidden group"
            data-aos="fade-left"
          >
