...
const InfoBox = ({ icon, title, desc }) => (
  <div className="p-8 bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl">
    ...
    <h4 className="text-sm font-black uppercase text-dark dark:text-white mb-2">
      {title}
    </h4>
  ...
  return (
    <section className="py-20 bg-gray-50 dark:bg-dark">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-xl sm:text-2xl font-black text-center text-dark dark:text-white uppercase mb-16">
