...
const ConsultationExamples = () => {
  const cases = [
    {
      scenario:
        "High-level executive facing a significant moral and career dilemma during a major merger.",
      resolution:
        "Consultation revealed hidden karmic timing and misaligned vibration; advised a 3-month strategic pause which saved their long-term reputation.",
      impact: "Reputational Shield",
    },
    {
      scenario:
        "Individual feeling overwhelmed by a series of unfortunate events and stagnation in personal life.",
      resolution:
        "Human-led analysis provided emotional reassurance and a clear escape route via simple number shifts and signature corrections.",
      impact: "Crisis Resolution",
    },
  ];
...
export default ConsultationExamples;
