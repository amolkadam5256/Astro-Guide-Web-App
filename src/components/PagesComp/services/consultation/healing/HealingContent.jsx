...
const HealingContent = () => {
  return (
    <div data-aos="fade-right">
      <h1 className="text-4xl md:text-5xl font-black text-dark dark:text-white uppercase mb-8 leading-none">
        Frequency <br /> <span className="text-primary">Healing</span>
      </h1>
