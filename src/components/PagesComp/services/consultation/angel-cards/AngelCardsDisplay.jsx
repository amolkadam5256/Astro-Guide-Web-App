    ...
    <div className="flex justify-center flex-wrap gap-8 lg:gap-12">
      {[1, 2, 3].map((_, i) => (
        <div
          ...
          className="w-40 h-64 bg-primary/5 border-2 border-primary/20 rounded-xl flex items-center justify-center group hover:bg-primary transition-all cursor-pointer"
        >
