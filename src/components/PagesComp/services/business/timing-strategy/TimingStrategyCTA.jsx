        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="space-y-4">
            <h2 className="text-3xl md:text-5xl font-black text-dark dark:text-white uppercase tracking-tighter leading-none">
              Master <br />
              <span className="text-primary italic opacity-90">The Flow</span>
            </h2>
            <p className="text-sm md:text-lg text-gray-400 font-extrabold uppercase tracking-widest max-w-2xl mx-auto">
              Preparation is the difference between a crisis and a peak.
            </p>
          </div>
        </div>
...
export default TimingStrategyCTA;
