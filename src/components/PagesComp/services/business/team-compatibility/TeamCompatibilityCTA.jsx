      ...
      >
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="space-y-4">
            <h2 className="text-4xl md:text-7xl font-black text-dark dark:text-white uppercase tracking-tighter leading-none">
              Unify <br />
              <span className="text-primary italic opacity-90">The Pulse</span>
            </h2>
            <p className="text-base md:text-xl text-gray-400 font-extrabold uppercase tracking-widest max-w-2xl mx-auto">
              Build a team that resonates as one force.
            </p>
          </div>
        </div>
...
export default TeamCompatibilityCTA;
