      ...
      >
        <div className="flex flex-col items-center gap-6">
          <div className="w-16 h-16 bg-primary text-white rounded-none flex items-center justify-center shadow-2xl skew-x-12">
            <Briefcase className="w-8 h-8 -skew-x-12" />
          </div>
          <div className="space-y-4">
            <h2 className="text-3xl md:text-5xl font-black text-dark dark:text-white uppercase tracking-tighter leading-none">
              Scale <br />
              <span className="text-primary italic opacity-90">Vision</span>
            </h2>
            <p className="text-sm md:text-lg text-gray-400 font-bold uppercase tracking-widest max-w-2xl mx-auto">
              Build a business that isn't just profitable, but intrinsically
              successful.
            </p>
          </div>
        </div>
