...
const BusinessHero = () => {
  return (
    <section className="relative flex items-center justify-center overflow-hidden py-20 px-4 bg-white dark:bg-[#050a15]">
      <div
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-8">
        ...
        >
          ...
          <span>Corporate Growth Consulting</span>
        </div>

        <h1
          className="text-3xl md:text-4xl lg:text-6xl font-black text-dark dark:text-white mb-4 uppercase tracking-tighter"
          data-aos="fade-up"
        >
          Strategic <br />
          <span className="text-primary italic opacity-90">Business</span>
        </h1>
        ...
        <p
          ...
          data-aos-delay="100"
        >
          Leverage the power of numbers to build a brand that resonates with
          success and market authority. Scientific analysis for startups and
          corporations.
        </p>
