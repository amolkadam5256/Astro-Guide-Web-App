    ...
    <section className="py-20 px-4 bg-white dark:bg-[#050a15] overflow-hidden relative">
      ...
      <div className="max-w-4xl mx-auto relative group z-10">
        ...
        <div className="relative bg-white dark:bg-[#0a1020]  p-8 md:p-12 overflow-hidden border border-gray-100 dark:border-white/10 shadow-2xl">
          ...
          <div className="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 bg-primary/10  blur-3xl" />
          <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 bg-purple-500/10  blur-3xl" />

          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div className="space-y-4 max-w-lg">
              <div className="inline-flex items-center gap-2 px-3 py-1  text-[10px] font-black uppercase tracking-widest border border-amber-100 dark:border-amber-800/50">
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium text-sm md:text-base">
                Expert insights and premium reports to guide your journey.
              </p>
            </div>
