...
const HomeHero = () => {
  ...
  return (
    <div className="relative  flex items-center overflow-hidden bg-[#050a15] pt-16 lg:pt-0">
      {/* --- Cosmic Layers --- */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-4 items-center">
          ...
          <div className="text-left space-y-8 max-w-2xl mx-auto lg:mx-0 lg:pr-10">
            ...
            >
              <Link
                to="/contact"
                className="group relative px-10 py-5 bg-primary text-white font-black uppercase tracking-[0.2em] text-[11px] sm:text-xs hover:shadow-[0_0_50px_rgba(var(--color-primary),0.4)] transition-all overflow-hidden active:scale-95 text-center"
              >
